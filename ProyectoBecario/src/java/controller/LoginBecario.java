...
public class LoginBecario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!verificarSesionYCookie(request)) {
            ...
            request.getRequestDispatcher("/ProyectoBecario/jsp/usuario.jsp").forward(request, response);
        }
    }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (BCrypt.checkpw(password, hashPassword)) {
                    ...
                    response.sendRedirect("/ProyectoBecario/jsp/becario.jsp");
                } else {
                    request.setAttribute("error", "Contraseña incorrecta");
                    request.getRequestDispatcher("/ProyectoBecario/jsp/error.jsp").forward(request, response);
                }
            } else {
